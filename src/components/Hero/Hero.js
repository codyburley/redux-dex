    ...
    <section className="hero">
      <div className="hero__title-container">
        ...
        <div className="hero__button-wrapper">
          <button
            className={`hero__gender-button hero__gender-button--male ${
              gender === "female" ? " hero__gender-button--inactive" : ""
            }`}
          ...
          <button
            className={`hero__gender-button hero__gender-button--female ${
              gender === "male" ? " hero__gender-button--inactive" : ""
            }`}
            onClick={handleGenderClick}
          >
          ...
          <button
            className={`hero__shiny-button ${
              !shiny ? "" : " hero__shiny-button--active"
            }`}
            onClick={() => (shiny ? setShiny(false) : setShiny(true))}
          >
            <AutoAwesomeIcon
              className={`hero__shiny ${!shiny ? "" : " hero__shiny--active"}`}
            />
          </button>
        </div>
      </div>
      <div className="hero__body-container">
        <div className="hero__switch-wrapper">
          ...
          <Switch
            size="small"
            onChange={() =>
              gen === "home" ? setGen("classic") : setGen("home")
            }
          />
        </div>
        <div className="hero__image-container">
          <img src={currentSprite} alt={capitalName} className="hero__image" />
        </div>
          ...
          {gen === "home" ? (
            ...
            <>
              <div className="hero__image-divider">
                ...
                <span className="hero__image-count">
                  {back === false ? "1" : "2"}/2
                </span>
              </div>
              <button
