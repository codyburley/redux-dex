    ...
    <section className="description">
      {types.map((type) => {
        return (
          <div
            key={type.type.name}
            className={`description__type-container description__type-container--${type.type.name}`}
          >
      ...
      <article className="description__wrapper">
        ...
        <div className="description__flavor-container">
          <p className="description__flavor-text">
            {description.flavor_text_entries[1].flavor_text.replace(
              /[^a-z0-9 é . , ' " /]/gi,
              " "
            )}
          </p>
      ...
      <div className="description__measurement-container">
        ...
        <div className="description__measurement">
          ...
          <p className="description__measurement-text">
